...
my_fulfillment = cc.PreimageSha256(array.array("B", range(256)).tostring() * 16)
print(my_fulfillment.condition_uri)
...
my_condition.type_id = cc.PreimageSha256.TYPE_ID
my_condition.bitmask = cc.PreimageSha256.FEATURE_BITMASK
