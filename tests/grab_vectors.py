...
vectors_base_url = ('https://raw.githubusercontent.com/rfcs/'
                    'crypto-conditions/master/test-vectors/valid/')
...
def download_vectors(vectors_base_url=vectors_base_url,
    ...
    for vector_name in vector_names:
        ...
        vector_data = json.loads(
            urlopen(
                '{}{}.json'.format(vectors_base_url, vector_name)
            ).read().decode()
        )
