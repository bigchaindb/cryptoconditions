...
class TestFulfillment:
    ...
    def test_serialize_binary_raises_with_non_initialize_simple_types(self, simple_cryptocondition_type):
        ...
        err_msg = ('Internal error! Failed to transform dict "{}" ' "into pyasn1 schema object.").format(
...
class TestThresholdSha256Fulfillment:
    def test_serialize_signed_dict_to_fulfillment(self, fulfillment_threshold):
        ...
        assert fulfillment.to_dict() == {
            "bitmask": 43,
            "subfulfillments": [
                {"bitmask": 3, "preimage": "", "type": "fulfillment", "type_id": 0, "weight": 1},
                {
                    "bitmask": 32,
    ...
    def test_fulfillment_nested_and_or(
        self, fulfillment_sha256, fulfillment_ed25519, fulfillment_threshold_nested_and_or
    ):
