...
def test_find_by_asn1_condition_type():
    ...
    registered_type = TypeRegistry.find_by_asn1_condition_type("preimageSha256Condition")
    assert registered_type["asn1_condition"] == PreimageSha256.TYPE_ASN1_CONDITION
...
def test_find_by_asn1_fulfillment_type():
    ...
    registered_type = TypeRegistry.find_by_asn1_fulfillment_type("preimageSha256Fulfillment")
    assert registered_type["asn1_fulfillment"] == PreimageSha256.TYPE_ASN1_FULFILLMENT
